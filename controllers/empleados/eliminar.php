...
if ($result = $con->query($sql)) {
  if ($con->affected_rows > 0) {
    ...
    echo json_encode(array('code' => 200, 'message' => 'Se ha eliminado satisfactoriamente el cliente '.$id));
  } else {
    $con->rollback();
    http_response_code(400);
    echo json_encode(array('error' => array('code' => 400, 'message' => 'No se ha encontrado un cliente con el id especificado')));
  }  
} else {
  $con->rollback();
